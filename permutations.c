/*Алгоритм порождения всех перестановок. By Ivan Gavryushin.  dcc0@mail.ru, dcc0@yandex.ru, ivangavr777@gmail.com. Yar.Oblast - MSK. 2010-2020. †☦☩ */
#include <stdio.h>
#include <string.h>
...
int main(int argc, char* argv[]) {
  ...
  char ch[33];  /*Хранит перевернутую копию аргумента. Reversed copy of an*/
                /*argument*/
